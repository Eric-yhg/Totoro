# Generated by Django 2.1b1 on 2019-01-05 08:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('sercuritydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobs', models.CharField(choices=[('H5', '前端'), ('JAVA', '后端'), ('TEST', '测试'), ('SA', '运维')], max_length=64, verbose_name='工种')),
            ],
            options={
                'verbose_name': '用户',
