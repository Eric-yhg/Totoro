...
class User2(models.Model):
    ...
    name = models.CharField(max_length=64,unique=True,verbose_name='姓名')   #verbose_name 显示名称
    ...
    jobs = models.CharField(max_length=64,choices=category,verbose_name='工种')
    def __str__(self):
        return self.name
    class Meta:
        verbose_name = '用户'
...
#     user = models.ForeignKey(User2,on_delete=models.CASCADE,verbose_name='拥有者')
...
class Server(models.Model):
    ...
    hosted_on = models.ForeignKey('self', related_name='hosted_on_server',on_delete=models.CASCADE,blank=True, null=True, verbose_name="宿主机")  # 虚拟机专用字段
